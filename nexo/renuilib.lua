if game.CoreGui.RobloxGui:FindFirstChild("Test UI") then game.CoreGui.RobloxGui:FindFirstChild("Test UI"):Destroy() end
local library = {RainbowColorValue = 0, HueSelectionPosition = 0}
local PresetColor = Color3.fromRGB(0, 120, 0)
...
function library:Window(name,game)
	if getgenv().Theme ~= nil then
		...
		ColorII = Color3.fromRGB(110, 0, 255)

		ColorIII = Color3.fromRGB(110, 0, 255)
		ColorIIII = Color3.fromRGB(0, 0, 255)

		ColorIIIII = Color3.fromRGB(110, 0, 255)
		ColorIIIIII = Color3.fromRGB(0, 0, 255)

		ColorIIIIIII = Color3.fromRGB(110, 0, 255)
	...
	Main.Size = UDim2.new(0, 550, 0, 425)
	...
	Toggleui.Size = UDim2.new(0, -20, 0, 30)
	Toggleui.Font = Enum.Font.SourceSansSemibold
	Toggleui.Text = "[ Insert ]"
	Toggleui.TextColor3 = Color3.fromRGB(110, 0, 255)
	...
	SizeFullSection.Size = UDim2.new(0, 1200, 0, 340)
	...
	TabSet.Text = ""
	TabSet.TextColor3 = Color3.fromRGB(110, 0, 255)
	TabSet.PlaceholderColor3 = Color3.fromRGB(110, 0, 255)
	...
	function Tabs:Tab(text,Real)
		...
		MainSection.Size = UDim2.new(0, 400, 0, 0)
		...
		SectionBorder.ImageColor3 = Color3.fromRGB(110, 0, 255)
		...
		if fspage == nil then
			...
			TweenService:Create(MainSection, TweenInfo.new(0.5, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Size = UDim2.new(0, 400, 0, 355)}):Play()
		...
		Tab.MouseButton1Click:Connect(function()
			for i, v in next, SizeFullSection:GetChildren() do
				if v.Name == "MainSection" then
					TweenService:Create(v, TweenInfo.new(0.5, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Size = UDim2.new(0, 400, 0, 0)}):Play()
					v.Visible = false
				end
				MainSection.Visible = true
				TweenService:Create(MainSection, TweenInfo.new(0.5, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Size = UDim2.new(0, 400, 0, 355)}):Play()
		...
		function TabElements:Button(text,callback)
			...
			NameButton.Size = UDim2.new(0, 350, 0, 30)
			NameButton.ZIndex = 5
			...
			Button.MouseEnter:connect(function()
				TweenService:Create(
					...
					{TextColor3 = Color3.fromRGB(110, 0, 255)}
				):Play()
			end)
		...
		function TabElements:Toggle(text,stats,callback)
			...
			ToggleName.Size = UDim2.new(0, 350, 0, 35)
			ToggleName.ZIndex = 5
			...
			local function SetState(state)
				if state then
					TweenService:Create(Title, TweenInfo.new(0.12, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {TextColor3 = Color3.fromRGB(110, 0, 255)}):Play()
		...
		function TabElements:Slider(name, minimumvalue, maximumvalue, presetvalue, precisevalue, callback)
			...
			SliderName.Size = UDim2.new(0, 350, 0, 50)
			SliderName.ZIndex = 5
			...
			SliderBackground.Size = UDim2.new(0, 335, 0, 4)
      ...
      function funcSli:SetSliderValue(value)
				if Lock.Visible == true then
					for i = 1,3 do
						TweenService:Create(lock, TweenInfo.new(0.1, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Rotation = 10}):Play()
						wait(.1)
				...
				if tonumber(value) <= minimumvalue then
					Value.Text = minimumvalue
				elseif tonumber(value) >= maximumvalue then
					Value.Text = maximumvalue
          else
            Value.Text = tostring(value or precisevalue and tonumber(string.format("%.2f", value)))
				end
		...
		function TabElements:Dropdown(name, options, presetoption, callback)
			...
			if type(presetoption) == "number" then
				if presetoption <= 0 then
					...
					if options[presetoption] ~= nil then
						...
						TitleToggle.TextColor3 = Color3.fromRGB(110, 0, 255)
			...
			NameDropdown.Size = UDim2.new(0, 350, 0, 30)
			...
			TitleToggle.Size = UDim2.new(0, 350, 0, 30)
			...
			Dropdown.Size = UDim2.new(0, 320, 0, 0)
			Dropdown.ZIndex = 15
			...
			local function ClearAllDropdownItems()
				...
				TweenService:Create(NameDropdown, TweenInfo.new(0.5, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Size = UDim2.new(0, 350, 0, 30)}):Play()
				TweenService:Create(Dropdown, TweenInfo.new(0.5, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Size = UDim2.new(0, 320, 0, 0)}):Play()
			end
			...
			for i, v in pairs(options) do
				...
				NameButton.Size = UDim2.new(0, 335, 0, 25)
				...
				NameButton.MouseButton1Down:Connect(function()
					...
					if SelectedOption ~= "nil" then
						TweenService:Create(TitleToggle, TweenInfo.new(0.5, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(110, 0, 255)}):Play()
					end
					TweenService:Create(NameDropdown, TweenInfo.new(0.5, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Size = UDim2.new(0, 350, 0, 30)}):Play()
					...
					TweenService:Create(Dropdown, TweenInfo.new(0.5, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Size = UDim2.new(0, 335, 0, 0)}):Play()
			...
			TitleToggle.MouseButton1Down:Connect(function()
				...
				elseif not DropdownToggled then
					if Lock.Visible == true then
						...
						TweenService:Create(NameDropdown, TweenInfo.new(0.5, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Size = UDim2.new(0, 350, 0, 115)}):Play()
						...
						TweenService:Create(Dropdown, TweenInfo.new(0.5, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Size = UDim2.new(0, 320, 0, 75)}):Play()
		...
		function TabElements:ColorPicker(name, presetcolor, callback)
			...
			NameColorPicker.Size = UDim2.new(0, 350, 0, 30)
			...
			ColorPickerToggle.MouseButton1Click:Connect(function()
				...
				if ColorPickerToggled then
					TweenService:Create(NameColorPicker, TweenInfo.new(0.5, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Size = UDim2.new(0, 350, 0, 160)}):Play()
				...
				elseif not ColorPickerToggled then
					TweenService:Create(NameColorPicker, TweenInfo.new(0.5, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Size = UDim2.new(0, 350, 0, 30)}):Play()
		...
		function TabElements:Line()
			...
			Line.BackgroundColor3 = Color3.fromRGB(110, 0, 255)
			Line.BackgroundTransparency = 1.000
			Line.Position = UDim2.new(0, 0, 0.298245609, 0)
			Line.Size = UDim2.new(0, 350, 0, 5)
			Line.ZIndex = 5

			Button.Name = "Button"
			Button.Parent = Line
			Button.BackgroundColor3 = Color3.fromRGB(110, 0, 255)
			Button.BackgroundTransparency = 1.000
			Button.BorderSizePixel = 0
			Button.ClipsDescendants = true
			Button.Size = UDim2.new(0, 350, 0, 5)
			Button.ZIndex = 6
			Button.Font = Enum.Font.SourceSansBold
			Button.Text = ""
		...
		function TabElements:Label(text)
			...
			Label.Size = UDim2.new(0, 350, 0, 35)
			Label.ZIndex = 5
			Label.RichText = true
			Label.Text = text
			Label.Font = Enum.Font.SourceSansBold
			Label.TextColor3 = Color3.fromRGB(110, 0, 255)
		...
		function TabElements:LabelList(name)
			...
			local function ClearAllDropdownItems()
				...
				TweenService:Create(NameDropdown, TweenInfo.new(0.5, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Size = UDim2.new(0, 350, 0, DropdownContentLayout.AbsoluteContentSize.Y + 45)}):Play()
			...
			TweenService:Create(TitleToggle, TweenInfo.new(0.5, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(185, 185, 185)}):Play()
			TweenService:Create(NameDropdown, TweenInfo.new(0.5, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {Size = UDim2.new(0, 350, 0, DropdownContentLayout.AbsoluteContentSize.Y + 30)}):Play()
			TweenService:Create(Dropdown, TweenInfo.new(0.5, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {CanvasSize = UDim2.new(0, 0, 0, DropdownContentLayout.AbsoluteContentSize.Y)}):Play()
